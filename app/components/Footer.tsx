...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/jonathan-vicente-mota/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container-max section-padding">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              e experiências de usuário excepcionais com tecnologias modernas.
            </p>
          </motion.div>
        ...
        >
          <p className="text-gray-400">
            © {currentYear} Jonathan. All rights reserved. Built with Next.js, TypeScript, and Tailwind CSS.
          </p>
        </motion.div>
      </div>
    </footer>
